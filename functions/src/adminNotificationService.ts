...
interface AdminNotification {
  type: 'rsvp' | 'message' | 'account_request' | 'feedback' | 'resource_submission' | 'volunteer_signup';
  title: string;
  message: string;
  data?: any;
...
export class AdminNotificationService {
   ...
   */
  private async sendEmailNotifications(admins: any[], notification: AdminNotification): Promise<void> {
   ...
   */
  private async sendPushNotifications(admins: any[], notification: AdminNotification): Promise<void> {
    ...
    const message: admin.messaging.MulticastMessage = {
      ...
      data: {
        ...
        actionUrl: notification.actionUrl || '/admin/dashboard',
        ...notification.data,
      },
      webpush: {
        notification: {
   ...
   */
  private async cleanupInvalidTokens(tokens: string[], responses: admin.messaging.SendResponse[]): Promise<void> {
   ...
   */
  private async logNotification(notification: AdminNotification, recipientCount: number): Promise<void> {
   ...
   */
  private generateEmailHTML(notification: AdminNotification, admin: any): string {
