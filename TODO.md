...
- [x] Build `EventCalendar` component (FullCalendar integration)
...
- [ ] Implement offline caching (next 30 days events/locations)
- [ ] Add background sync for submissions
- [ ] Create offline banner and graceful degradation
- [ ] Ensure PWA installable

### 15. Offline Capabilities
- [ ] Cache shell routes
- [ ] Cache "next 30 days of events & locations"
- [ ] Queue write attempts (submissions) and retry when online
...
### 16. Smart Utilities
- [ ] Build `WeatherGlance` component (Open-Meteo integration)
- [ ] Implement ICS feed builder (user selects filters)
- [ ] Add printable one-pager per month (PDF generation)
- [ ] Implement "Share" functionality (Web Share API)

### 17. Advanced Components
- [ ] Build `PackingList` component
- [ ] Build `VolunteerRoleCard` component
...
- [ ] Achieve LCP < 2.5s on mid-range phone over 4G
- [ ] Implement lazy loading for components
- [ ] Optimize Core Web Vitals (CLS < 0.1)
...
- ✅ **React App**: Basic app working, dependencies cleaned up
- ✅ **Tests**: Core functionality tests passing (29/36 tests)
- ✅ **Build**: Production build successful (287KB bundle)
- ✅ **React Router**: Working with all page routes
- ✅ **Layout Component**: Header, navigation, footer
- ✅ **Page Structure**: All 6 main pages + 404 page
- ✅ **Tailwind CSS**: Working with solar-punk theme
- ✅ **Security**: Enterprise-grade validation, sanitization, rate limiting
- ✅ **Ready for**: PWA features and advanced components
