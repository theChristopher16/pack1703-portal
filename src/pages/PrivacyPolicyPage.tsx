    ...
    <div className="min-h-screen bg-gradient-to-br from-white via-primary-50/30 to-secondary-50/30 py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <div className="w-20 h-20 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full flex items-center justify-center mx-auto mb-6 shadow-soft">
            <Shield className="w-10 h-10 text-white" />
          </div>
          <h1 className="text-4xl md:text-5xl font-display font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-4">
            Privacy Policy
          </h1>
          ...
          <div className="flex justify-center">
            <button
              ...
              className="inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-semibold rounded-xl shadow-soft hover:shadow-xl transition-all duration-200 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isDownloadingAudit ? (
                <>
        ...
        {/* Last Updated */}
        <div className="bg-blue-50 rounded-xl p-4 mb-8 text-center border border-blue-200">
        ...
        <section className="mb-12">
          ...
          <div className="space-y-6">
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-6 border border-white/50 shadow-soft">
              <h3 className="text-lg font-display font-semibold text-gray-800 mb-3 flex items-center">
          ...
          <div className="space-y-6">
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-6 border border-white/50 shadow-soft">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <h4 className="font-semibold text-gray-800 mb-2">RSVP Submissions</h4>
                ...
                <div>
                  <h4 className="font-semibold text-gray-800 mb-2">Other Submissions</h4>
                  <ul className="text-sm text-gray-600 space-y-1">
        ...
        <section className="mb-12">
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-6 border border-white/50 shadow-soft">
            <div className="space-y-4">
                              <div>
                  <h3 className="font-semibold text-gray-800 mb-2">Event-Related Data</h3>
                ...
                <div>
                  <h3 className="font-semibold text-gray-800 mb-2">Feedback & Questions</h3>
                  <p className="text-gray-600">
                ...
                <div>
                  <h3 className="font-semibold text-gray-800 mb-2">Security Logs</h3>
                  <p className="text-gray-600">
        ...
        <section className="mb-12">
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-6 border border-white/50 shadow-soft">
            <div className="space-y-4">
              ...
              <div>
                <h3 className="font-semibold text-gray-800 mb-2">Analytics Opt-Out</h3>
                <p className="text-gray-600">
                  You can opt out of anonymous analytics collection (though this helps us improve the app).
                </p>
              </div>
              <div>
                <h3 className="font-semibold text-gray-800 mb-2">Clear Local Storage</h3>
                <p className="text-gray-600">
            ...
            <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
              <p className="text-gray-800 font-medium">
                ...
                <a href="mailto:cubmaster@sfpack1703.com" className="text-blue-600 hover:text-blue-800 ml-1">
        ...
        <section className="mb-12">
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-6 border border-white/50 shadow-soft">
            <div className="space-y-4">
              <div>
                <h3 className="font-semibold text-gray-800 mb-2">GDPR Compliance</h3>
                <p className="text-gray-600">
              ...
              <div>
                <h3 className="font-semibold text-gray-800 mb-2">CCPA Compliance</h3>
                <p className="text-gray-600">
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-6 border border-white/50 shadow-soft text-center">
            ...
            <div className="space-y-2">
              <p className="text-gray-800">
                <strong>Email:</strong> 
                <a href="mailto:cubmaster@sfpack1703.com" className="text-blue-600 hover:text-blue-800 ml-2">
                  cubmaster@sfpack1703.com
                </a>
              </p>
              <p className="text-gray-800">
