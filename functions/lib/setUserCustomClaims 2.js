...
exports.syncAllUserCustomClaims = exports.setUserCustomClaims = void 0;
...
exports.setUserCustomClaims = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        const callingUserRole = (_a = callingUserDoc.data()) === null || _a === void 0 ? void 0 : _a.role;
        ...
        const userRole = (userData === null || userData === void 0 ? void 0 : userData.role) || 'parent';
...
exports.syncAllUserCustomClaims = functions.https.onCall(async (data, context) => {
    var _a;
...
//# sourceMappingURL=setUserCustomClaims.js.map