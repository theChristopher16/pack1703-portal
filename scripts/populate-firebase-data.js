...
const locations = [
  {
    ...
    category: 'campground',
    geo: { lat: 30.5918, lng: -95.1295 },
    notesPublic: 'Beautiful forest recreation area with camping, hiking, and fishing opportunities. Popular destination for Scout camping trips.',
    notesPrivate: 'Reservations recommended. Contact: (936) 653-3448',
    parking: {
      text: 'Free parking available',
      instructions: 'Follow signs to designated camping areas'
    },
  ...
  },
  {
    ...
    category: 'church',
    geo: { lat: 29.7377, lng: -95.4434 },
    notesPublic: 'Our charter organization and primary meeting location for Pack events.',
    notesPrivate: 'Main contact: (713) 622-5710. Website: https://www.stlukesmethodist.org',
    parking: {
  ...
  },
  {
    ...
    notesPublic: 'Large urban park with trails, sports fields, and natural areas. Great location for community service projects and outdoor activities.',
    notesPrivate: 'Contact: (713) 845-1000. Hours: 6:00 AM - 11:00 PM',
    parking: {
      text: 'Free parking available',
      instructions: 'Multiple parking lots throughout the park'
    },
  ...
  },
  {
    ...
    category: 'campground',
    geo: { lat: 30.5377, lng: -95.4434 },
    notesPublic: 'National forest with extensive hiking trails and outdoor recreation opportunities. Excellent location for hiking and outdoor education.',
    notesPrivate: 'Contact: (936) 344-6205. Website: https://www.fs.usda.gov/texas',
    parking: {
      text: 'Free parking at trailheads',
  ...
  },
  {
    ...
    notesPrivate: 'Street parking and paid lots available',
    parking: {
