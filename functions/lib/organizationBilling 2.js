...
exports.getOrganizationUsage = exports.createOrganizationBillingAccount = void 0;
 ...
 */
exports.createOrganizationBillingAccount = functions.https.onCall(async (data, context) => {
    ...
    const isSuperAdmin = (userData === null || userData === void 0 ? void 0 : userData.role) === 'super-admin' || (userData === null || userData === void 0 ? void 0 : userData.role) === 'root';
    if (!isSuperAdmin) {
        throw new functions.https.HttpsError('permission-denied', 'Only super admins can create billing accounts');
    }
    ...
    try {
        ...
        throw new functions.https.HttpsError('internal', `Failed to create/link billing account: ${error.message}`);
    }
});
/**
 ...
 */
exports.getOrganizationUsage = functions.https.onCall(async (data, context) => {
    // Verify authentication
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'User must be authenticated');
    }
    ...
    try {
        ...
        const billingAccountId = orgData === null || orgData === void 0 ? void 0 : orgData.billingAccountId;
        if (!billingAccountId) {
            return {
                success: false,
        ...
        throw new functions.https.HttpsError('internal', `Failed to get organization usage: ${error.message}`);
    }
});
