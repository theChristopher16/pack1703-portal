...
exports.autoLinkToPack1703 = exports.linkUserToOrganization = void 0;
 ...
 */
exports.linkUserToOrganization = functions.https.onCall(async (data, context) => {
    ...
    if (context.auth.token.super !== true && context.auth.token.super_admin !== true) {
        throw new functions.https.HttpsError('permission-denied', 'Only super admins can link users to organizations');
    }
    const { userId, organizationId, role } = data;
    if (!userId || !organizationId) {
        throw new functions.https.HttpsError('invalid-argument', 'userId and organizationId are required');
    }
    try {
 ...
 */
exports.autoLinkToPack1703 = functions.https.onCall(async (data, context) => {
    var _a;
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'User must be authenticated');
    }
    ...
    try {
        ...
        const userRole = userDoc.exists ? ((_a = userDoc.data()) === null || _a === void 0 ? void 0 : _a.role) || 'parent' : 'parent';
        // Create the link
        const crossOrgRef = await db.collection('crossOrganizationUsers').add({
            userId,
...
//# sourceMappingURL=linkUserToOrganization.js.map