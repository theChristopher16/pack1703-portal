...
const AnnouncementCard: React.FC<AnnouncementCardProps> = ({
  ...
  return (
    ...
    >
      {/* Pinned Badge */}
      {announcement.pinned && (
        <div className="absolute top-2 right-2 flex items-center space-x-1 px-2 py-1 bg-yellow-100 text-yellow-800 rounded-full text-xs font-medium shadow-sm z-10">
