 ...
 * Tests the new popup + redirect fallback authentication system
 */
...
async function testAuthenticationFlow() {
  console.log('🧪 Testing Modern Authentication Flow...\n');
  ...
  try {
    ...
    try {
      ...
      await getDocs(q);
      console.log('⚠️  Anonymous access unexpectedly allowed - App Check may not be enforced');
    } catch (error) {
    ...
    if (!testPassword) {
      ...
      console.log('✅ Modern authentication flow is ready for testing');
      return;
    }
    ...
    console.log('- ✅ Modern popup + redirect authentication is ready');
