...
exports.createSuperAdminUser = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        const newUser = {
            ...
            firstName: data.firstName || ((_a = authUser.displayName) === null || _a === void 0 ? void 0 : _a.split(' ')[0]) || '',
            lastName: data.lastName || ((_b = authUser.displayName) === null || _b === void 0 ? void 0 : _b.split(' ').slice(1).join(' ')) || '',
            phone: data.phone || '',
