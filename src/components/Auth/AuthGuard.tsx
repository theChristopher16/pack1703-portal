            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                ...
                <div className="bg-white rounded-brand shadow-card border border-cloud p-8 text-center">
                  <div className="w-16 h-16 bg-gradient-to-br from-moss/40 to-teal/40 rounded-brand flex items-center justify-center mx-auto mb-6">
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-12">
                ...
                <div className="bg-white rounded-brand shadow-card border border-cloud p-6 text-center hover:shadow-lg transition-all duration-300">
                  <div className="w-16 h-16 bg-gradient-to-br from-moss/40 to-teal/40 rounded-brand flex items-center justify-center mx-auto mb-4">
                    <span className="text-white text-2xl">🎒</span>
                  </div>
                ...
                <div className="bg-white rounded-brand shadow-card border border-cloud p-6 text-center hover:shadow-lg transition-all duration-300">
                  <div className="w-16 h-16 bg-gradient-to-br from-teal/40 to-moss/40 rounded-brand flex items-center justify-center mx-auto mb-4">
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="bg-white rounded-brand shadow-card border border-cloud p-6 text-center hover:shadow-lg transition-all duration-300 hover:scale-105">
                  <div className="w-12 h-12 bg-gradient-to-br from-moss/40 to-teal/40 rounded-brand flex items-center justify-center mx-auto mb-4">
                ...
                {/* Announcements */}
                <div className="bg-white rounded-brand shadow-card border border-cloud p-6 text-center hover:shadow-lg transition-all duration-300 hover:scale-105">
                  <div className="w-12 h-12 bg-gradient-to-br from-teal/40 to-moss/40 rounded-brand flex items-center justify-center mx-auto mb-4">
                    <span className="text-white text-xl">📢</span>
                  </div>
                ...
                <div className="space-y-6">
                  <div className="bg-white rounded-brand shadow-card border border-cloud p-6">
                    <div className="flex items-start space-x-4">
                      <div className="w-12 h-12 bg-gradient-to-br from-moss/40 to-teal/40 rounded-brand flex items-center justify-center flex-shrink-0">
                        <span className="text-white text-xl">🌟</span>
                      </div>
                      <div>
                  ...
                  <div className="bg-white rounded-brand shadow-card border border-cloud p-6">
                    <div className="flex items-start space-x-4">
                      <div className="w-12 h-12 bg-gradient-to-br from-teal/40 to-moss/40 rounded-brand flex items-center justify-center flex-shrink-0">
                        <span className="text-white text-xl">👨‍👩‍👧‍👦</span>
                      </div>
                      <div>
